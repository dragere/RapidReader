  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        ...
        <div>
          <q-btn round flat icon="help" @click="showHelp = true"></q-btn>
          <q-btn round flat href="https://github.com/dragere/RapidReader" target="_blank"><span class="q-icon" aria-hidden="true" role="presentation"><svg
      ...
      <q-dialog v-model="showHelp">
        <q-card>
          <q-card-section>
            ...
            Bookmarklet
          </span> to access rapid reader. When you have selected text on a website and click the bookmarklet it will be
            committed to the reader.
          </q-card-section>

          <q-card-section class="q-pt-none">
            You can use the arrow keys to change the speed and jump around. Using space you can start/pause.
          </q-card-section>
        </q-card>
      </q-dialog>
    </q-page-container>
